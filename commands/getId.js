...
async function sendPrompt(message) {
  ...
  const embed = new EmbedBuilder()
    ...
    .setTitle("<:Web:1522000825361235998>〃NOVɅ - Registre des CI")
    .setDescription(
...
async function handleButton(interaction) {
  ...
  const modal = new ModalBuilder().setCustomId(GET_MODAL_ID).setTitle("Recherche — Registre NOVɅ");
